		...
		function previousPage()
		{
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert("yes");
			    window.location.assign("checkedInvitationMgrChen?mid=3&checked="+checkedL+"&selectAll="+selectAll);
		}
		function nextPage()
		{
			...
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert(checkedL+selectAll);
			    window.location.assign("checkedInvitationMgrChen?mid=1&checked="+checkedL+"&selectAll="+selectAll);
		}
		function turnTo()
		{
			//alert(""+checkedL);
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     window.location.assign("checkedInvitationMgrChen?mid=4&page="+page+"&checked="+checkedL+"&selectAll="+selectAll);
		}
		function passOne(id)
		{
			//alert(""+checkedL);
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert("yes");
			    window.location.assign("checkedInvitationMgrChen?mid=2&id="+id+"&checked="+checkedL+"&selectAll="+selectAll);
		}
		function nopassOne(id)
		{
			...
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert("yes");
			    window.location.assign("checkedInvitationMgrChen?mid=5&id="+id+"&checked="+checkedL+"&selectAll="+selectAll);
		}
		function passAll()
		{
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert("yes");
			    window.location.assign("checkedInvitationMgrChen?mid=7&checked="+checkedL+"&selectAll="+selectAll);
		}
		function nopassAll()
		{
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert("yes");
			    window.location.assign("checkedInvitationMgrChen?mid=8&checked="+checkedL+"&selectAll="+selectAll);
		}
		function seeInvitation(id)
		{
			...
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert("yes");
			    window.location.assign("checkedInvitationMgrChen?mid=10&id="+id+"&checked="+checkedL+"&selectAll="+selectAll);
		}
		...
		function seeStudent(id)
		{
			...
			for(var i=0;i<n;i++){ 
				...
				if(document.getElementsByName("uncheckedInvitationChecked")[i].checked){
			     ...
			     //alert("yes");
			    window.location.assign("checkedInvitationMgrChen?mid=11&id="+id+"&checked="+checkedL+"&selectAll="+selectAll);
		}
	...
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    ...
			    <li><a href="logicMgr?mid=3" class="active"><span>帖子管理</span></a></li>
			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="box-head">
						<h2 class="left"></h2>
						<div class="right">
						<form action="checkedInvitationMgrChen?mid=9" method="post">
							<label>添加者ID号：</label>
					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr <% if((i%2)!=0) out.print("class='odd'"); %>>
								...
								<td><a onclick="nopassOne(<%=i %>)" class="ico del">删除</a></td>
							</tr>
							<% 
							}
							%>
			...
			<div id="sidebar">
				...
				<div class="box">
					...
					<div class="box-content">
						...
						<p><a onclick="nopassAll()" class="ico del">删除</a></p>
						
						<!-- Sort -->
						<div class="sort">
							<label>选择排序方式</label>
							<form action="checkedInvitationMgrChen?mid=6" method="post">
