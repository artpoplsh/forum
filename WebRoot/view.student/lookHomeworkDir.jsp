  ...
  <body >
    ...
    <div class="jumbotron">
       <div style="margin-top: 9px; height: 0px;">
        <h3 style="display:inline ">作业文件夹列表</h3>
      </div>
    </div>
    
	<div>
    <table class="table table-hover">
    	<tr><td Style="width:70%;">标题</td><td>操作</td></tr>
	    	<%
	    	    String id = (String)session.getAttribute("studentid");
				request.setCharacterEncoding("UTF-8");
		    	File file=new File(application.getRealPath("/homework"));
			...
			%>
						<tr>
							<td Style="width:300px;"><%=dir.getName() %></td>
							
							<td><a href="./view.student/studentUpload.jsp?dirName=<%=dir.getName() %>">进入</a></td>
						</tr>
			<%		}
				}
			%>
